/*!
 * Biblioteca JavaScript jQuery v3.6.0 -ajax,-ajax/jsonp,-ajax/load,-ajax/script,-ajax/var/location,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr ,-manipulation/_evalUrl,-deprecated/ajax-event-alias,-effects,-effects/Tween,-effects/animatedSelector
 *https://jquery.com/
 *
 * Inclui Sizzle.js
 * https://sizzlejs.com/
 ...
 */
 (função(global, fábrica) {
	...
	if ( tipo de módulo === "objeto" && tipo de módulo.exports === "objeto" ) {
		...
		// Veja o ticket #14549 para mais informações.
...
function matcherFromGroupMatchers( elementMatchers, setMatchers ) {
	var bySet = setMatchers.length > 0,
		...
		superMatcher = function( seed, context, xml, results, outermost ) {
			...
			// Suporte: IE<9, Safari
			// Tolera propriedades NodeList (IE: "comprimento"; Safari: <number>) combinando elementos por id
...
var rootjQuery,
	...
	// Prioriza #id sobre <tag> para evitar XSS via location.hash (#9521)
